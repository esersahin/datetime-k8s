...
# Beklenen: Hepsi Running (12 application pods + 3 ingress pods)
...
| **Application Pods** | 15 (3 C# API + 3 Go API + 6 Web + 3 Ingress)                       |
