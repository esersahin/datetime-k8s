...
| **Worker 1** | Ingress (1/3), C# API (1/3), Go API (1/3), C# Web (1/3), Go Web (1/3) | Application workloads |
| **Worker 2** | Ingress (2/3), C# API (2/3), Go API (2/3), C# Web (2/3), Go Web (2/3) | Application workloads |
| **Worker 3** | Ingress (3/3), C# API (3/3), Go API (3/3), C# Web (3/3), Go Web (3/3) | Application workloads |
