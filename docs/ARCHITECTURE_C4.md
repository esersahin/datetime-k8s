...
| Node | Pods | Roller |
|------|------|--------|
| **Control Plane** | Ingress, DNS, API Server | Cluster yönetimi |
| **Worker 1** | CSharp API, Go API, Web | Uygulama workload'ları |
| **Worker 2** | CSharp API, Go API x2, Web-Go | Uygulama workload'ları |
